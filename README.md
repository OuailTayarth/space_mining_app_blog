...
Astrolith is a full-stack application built with React/Typescript. It uses digital art to raise awareness about space resource utilization while celebrating black women in the space industry. The app and its blog work together to show how off-world solutions can solve Earth’s problems, like racial inequity and natural resource depletion. The blog shares news, publications, and stories, especially about women in space, to inspire future galactic pioneers and ambassadors.
